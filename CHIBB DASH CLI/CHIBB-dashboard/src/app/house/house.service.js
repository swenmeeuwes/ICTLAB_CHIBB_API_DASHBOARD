...
var HouseService = (function () {
    function HouseService(_http, _authenticationService, _config) {
        this._http = _http;
    ...
    HouseService.prototype.getHouses = function () {
        ...
        var promise = new Promise(function (resolve, reject) {
            ...
            var resultObservable = _this._http.get(_this._apiUrl + "/house?token=" + token, { headers: _this._headers })
    ...
    HouseService.prototype.createHouse = function (house) {
        ...
        return new Promise(function (resolve, reject) {
            var token = _this._authenticationService.getToken();
            var resultObservable = _this._http.post(_this._apiUrl + "/house?token=" + token, house, { headers: _this._headers })
                .map(function (response) { return response.json(); });
            resultObservable.subscribe(function (data) {
                console.log(data);
    ...
    HouseService.prototype.editHouse = function (house) {
        ...
        return new Promise(function (resolve, reject) {
            var token = _this._authenticationService.getToken();
            var resultObservable = _this._http.put(_this._apiUrl + "/house/" + house.hid + "?token=" + token, house, { headers: _this._headers })
                .map(function (response) { return response.json(); });
            resultObservable.subscribe(function (data) {
                resolve(data["responseCode"]);
            }, function (error) { reject(error.json()["responseCode"]); }, function () { clearTimeout(timeout); });
    ...
    HouseService.prototype.deleteHouse = function (house) {
        ...
        var promise = new Promise(function (resolve, reject) {
            if (!_this._authenticationService.isAuthenticated())
                reject({ errorMessage: "Not authenticated" });
            var token = _this._authenticationService.getToken();
            var resultObservable = _this._http.delete(_this._apiUrl + "/house/" + house.hid + "?token=" + token, { headers: _this._headers })
                .map(function (response) { return response.json(); });
            resultObservable.subscribe(function (data) {
                resolve(data["responseCode"]);
            }, function (error) { reject(error.json()["responseCode"]); }, function () { clearTimeout(timeout); });
